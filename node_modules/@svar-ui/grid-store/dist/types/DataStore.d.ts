...
import type { IColumn, IRenderColumn, IData, IDataConfig, IRow, TMethodsConfig, IExportOptions, TSortValue, IPrintConfig, IFilterValues } from "./types";
export default class DataStore extends Store<IData> {
    ...
    isCellEditable(row: IRow, column: IColumn): string | boolean | import("./types").IColumnEditor;
    ...
    searchRows(search: string, columns?: Partial<Record<TID, boolean>>): Record<TID, Partial<Record<TID, boolean>>>;
