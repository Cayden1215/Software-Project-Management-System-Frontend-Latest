...
import { useMemo as p, useRef as T, useContext as W, useCallback as Q, useEffect as R, createContext as ae, useState as $ } from "react";
import { context as V, TextArea as ie, Button as le, Locale as se, Willow as O, WillowDark as U } from "@svar-ui/react-core";
import { useWritableProp as E } from "@svar-ui/lib-react";
import { setID as G, dateToString as ce } from "@svar-ui/lib-dom";
import { ActionMenu as ue } from "@svar-ui/react-menu";
import { uid as de } from "@svar-ui/lib-state";
import { en as fe } from "@svar-ui/comments-locales";
import { en as me } from "@svar-ui/core-locales";
function xe(e) {
  if (e.startsWith("hsl"))
    return we(e)[2] > 55 ? "dark" : "light";
...
function Z({
  ...
  const i = p(
    ...
    () => e.color ? `wx-comments-avatar-color-${xe(e.color)}` : "",
    [e.color]
  );
  return /* @__PURE__ */ a(
    "div",
  ...
  return N.current = Q(
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a("div", { className: "wx-v2rD0VHO wx-textarea-bottombar", children: /* @__PURE__ */ a(le, { type: "primary", onClick: () => N.current(l), children: f(n) }) })
      ]
    }
  );
}
...
function ge({ owned: e, author: t, date: n, edit: o, children: i }) {
  const c = W(q).dateStr;
...
function K(e) {
  let t = "";
  for (const n of e)
    typeof n.d < "u" ? (t += "<" + n.t + ">", t += K(n.d), t += "</" + n.t + ">") : (n.t && (t += "<" + n.t + ">"), t += n.c, n.t && (t += "</" + n.t + ">"));
  return t;
}
function ye(e) {
  return K(be(e).nodes);
...
function Ne({ content: e }) {
  return /* @__PURE__ */ a("div", { dangerouslySetInnerHTML: { __html: ye(e) } });
}
...
function Se(e) {
  ...
  const u = W(V.i18n), { calendar: N, comments: h, formats: f } = u.getRaw(), d = u.getGroup("comments"), D = p(
    () => ce(h.dateFormat || f.dateFormat, N),
    [N, h, f]
  ), [C, L] = $(null), [k, j] = $(""), [b, M] = E(l);
  R(() => {
    j(""), L(null);
  }, [b]);
  const I = { id: 0, name: d("Unknown"), color: "hsl(0, 0%, 85%)" }, S = p(() => c ? c.map((r) => r.color ? r : {
    ...r,
    color: "hsl(" + X(r.id + r.name) + ", 100%, 85%)"
  }) : [], [c]), P = p(() => {
    if (typeof s == "object") return s;
    const r = S.find((x) => x.id === s) || I;
    return r || {
      id: s || -1,
      name: d("Me"),
      color: "hsl(225, 76%, 67%)"
  ...
  return /* @__PURE__ */ a(V.fieldId.Provider, { value: null, children: /* @__PURE__ */ a(
    q.Provider,
    {
      ...
      children: /* @__PURE__ */ y("div", { className: "wx-8ZGHQX6e wx-comments-list", children: [
        ...
        /* @__PURE__ */ a("div", { className: "wx-8ZGHQX6e wx-list", onClick: oe, children: /* @__PURE__ */ a(
          De,
          {
            author: P,
            render: i,
...
function Ze(e) {
  ...
  return /* @__PURE__ */ a(se, { words: { ...me, ...fe }, optional: !0, children: /* @__PURE__ */ a(Se, { data: m, ...i, onChange: l }) });
}
const qe = ({ children: e, fonts: t }) => e ? /* @__PURE__ */ a(O, { fonts: t, children: e }) : /* @__PURE__ */ a(O, { fonts: t }), je = ({ children: e, fonts: t }) => e ? /* @__PURE__ */ a(U, { fonts: t, children: e }) : /* @__PURE__ */ a(U, { fonts: t });
export {
  Ze as Comments,
  qe as Willow,
  je as WillowDark
