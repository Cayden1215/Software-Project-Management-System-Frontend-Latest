...
import { setID as _, uid as ee } from "@svar-ui/lib-dom";
...
function re({ items: n = [], css: e, values: r, width: c, onClick: i, onChange: s }) {
...
function we(n) {
  const {
    ...
    onClick: w,
    onChange: d
  } = n, [v, x] = Y(e || []), [h, u] = Y(i || null), f = R(() => le(v), [v]), C = N(null), F = N(-1), [S, T] = j([]), $ = N(f);
  I(() => {
    $.current = f;
  }, [v]);
  const O = N(s);
...
function ie({ id: n = "", text: e = "", css: r = "", icon: c = "", onClick: i }) {
  function s() {
    i && i({ id: n });
  }
