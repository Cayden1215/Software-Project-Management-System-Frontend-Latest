...
export interface IData extends Omit<IDataConfig, "tasks" | "links" | "rollups"> {
    rollups?: false | {
        type: "all" | "closest";
    };
    zoom?: IZoomConfig;
...
export type TEditorItem = TTextFieldShape | TCounterShape | TComboFieldShape | TSliderShape | TDateFieldShape | TRadioShape | ILinksShape | ITwoStateShape | TCheckboxShape;
